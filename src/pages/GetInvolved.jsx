...
import { Heart, Handshake, Briefcase, ChevronRight, Award, CheckCircle } from 'lucide-react';
        ...
        <div className="bg-white rounded-3xl border border-sahel-border shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7 p-8 sm:p-12 space-y-8">
            <div className="space-y-3">
              ...
              <p className="text-sm sm:text-base text-sahel-dark/70">Select a donation tier to fund critical field nurseries, farmer support materials, and ecological training kits in Yobe State.</p>
            </div>
          ...
          <div className="lg:col-span-5 bg-sahel-dark text-white p-8 sm:p-12 flex flex-col justify-between border-t-8 lg:border-t-0 lg:border-l-8 border-accent">
            ...
            <button
              ...
              className="mt-8 w-full bg-accent hover:bg-accent/90 text-sahel-dark font-bold py-4 rounded-xl transition-smooth shadow-lg text-sm text-center"
            >
              Complete Donation
            </button>
          </div>
